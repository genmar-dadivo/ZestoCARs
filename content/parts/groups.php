<div class="col-lg-12" id="tGresultdiv">
    <div class="container">
        <div class="row">
            <div class="card mt-5 border-0">
                <div class="card-body">
                    <div class="mt-5">
                        <table id="tgroups" class="table table-striped responsive nowrap" width="100%">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>NAME</th>
...
<script>
    //$("#customer-settings").on("change", function() {
        ...
        var table = $('#tgroups').DataTable({
            dom: 'frtip',
            "oLanguage": { "sSearch": "" },
            "ajax": {
                'type': 'POST',
                'url': '../action/getGroupsdata.php',
            },
